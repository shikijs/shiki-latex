...
test("renderToLaTeX()", async () => {
  ...
  expect(renderToLaTeX(lines)).toMatchInlineSnapshot(`
    ...
    \\\\textcolor[HTML]{0000FF}{const}\\\\textcolor[HTML]{000000}{ }\\\\textcolor[HTML]{001080}{name}\\\\textcolor[HTML]{000000}{ = }\\\\textcolor[HTML]{A31515}{\\"Leandro Facchinettti \\\\textbackslash{}\\\\{\\\\}%$#\\"}\\\\textcolor[HTML]{000000}{;}
    \\\\end{Verbatim}
    "
  `);
});
